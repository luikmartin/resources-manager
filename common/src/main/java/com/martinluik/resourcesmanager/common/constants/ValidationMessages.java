...
/**
 * Constants for validation error and warning messages.
 * These constants can be used in unit and integration tests to verify error messages.
 */
public final class ValidationMessages {
    ...
    public static final String STREET_ADDRESS_SIZE_RANGE = "Street address must be between 1 and 255 characters";
    public static final String STREET_ADDRESS_MAX_SIZE = "Street address must be less than 255 characters";
    ...
    public static final String POSTAL_CODE_PATTERN = "Postal code must be between 3 and 10 characters";
    ...
    public static final String CHARACTERISTIC_CODE_MAX_SIZE = "Characteristic code must not exceed 5 characters";
    ...
    public static final String CHARACTERISTIC_VALUE_SIZE_RANGE = "Characteristic value must be between 1 and 1000 characters";
    ...
    public static final String FAILED_TO_UPDATE_RESOURCE_LOCATION = "Failed to update resource location: ";
